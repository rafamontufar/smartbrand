...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="function">
                                <div class="widget">
                                    ...
                                    <ul class="cart-overview">
                                        <li>
                                            <a href="#">
                                                <img alt="Product" src="{{ URL::asset('assets/img/shop-widget-1.png') }}" />
                                        ...
                                        <li>
                                            <a href="#">
                                                <img alt="Product" src="{{ URL::asset('assets/img/shop-widget-2.png') }}" />
                                                <div class="description">
        ...
        <div class="main-container">
                ...
                <div class="container">
                        ...
                        <div class="col-sm-8 col-sm-offset-2">
                            <div class="local-video-container mb40">
                                <div class="background-image-holder">
                                    <img alt="Background Image" class="background-image" src="{{ URL::asset('assets/img/capital3.jpg') }}">
                                </div>
                                <video controls="">
                                    <source src="{{ URL::asset('assets/video/video.webm') }}" type="video/webm">
                                        <source src="{{ URL::asset('assets/video/video.mp4') }}" type="video/mp4">
                                            <source src="{{ URL::asset('assets/video/video.ogv') }}" type="video/ogg">
                                </video>
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center spread-children-large">
                            <img alt="pic" class="image-xxs mb-xs-8 fade-half" src="{{ URL::asset('assets/img/c1.png') }}" />
                            <img alt="pic" class="image-xxs mb-xs-8 fade-half" src="{{ URL::asset('assets/img/c2.png') }}" />
                            <img alt="pic" class="image-xxs mb-xs-8 fade-half" src="{{ URL::asset('assets/img/c3.png') }}" />
                            <img alt="pic" class="image-xxs mb-xs-8 fade-half" src="{{ URL::asset('assets/img/c4.png') }}" />
                        </div>
                    </div>
                    <!--end of row-->
                </div>
            ...
            <section class="image-edge pt120 pb120 pt-xs-40 pb-xs-40">
                <div class="col-md-6 col-sm-4 p0 col-md-push-6 col-sm-push-8">
                    <img alt="Screenshot" class="cast-shadow mb-xs-24" src="{{ URL::asset('assets/img/app3.jpg') }}" />
                </div>
                <div class="container">
                    <div class="col-md-5 col-md-pull-0 col-sm-7 col-sm-pull-4 v-align-transform">
                        ...
                        <div class="feature boxed">
                            ...
                            <div class="spread-children">
                                <img alt="Pic" class="image-xs" src="{{ URL::asset('assets/img/avatar1.png') }}" />
            ...
            <section class="image-edge pt120 pb120 pt-xs-40 pb-xs-40">
                <div class="col-md-6 col-sm-4 p0">
                    <img alt="Screenshot" class="mb-xs-24" src="{{ URL::asset('assets/img/app4.jpg') }}" />
                </div>
                <div class="container">
            ...
            <section class="image-bg overlay parallax">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="{{ URL::asset('assets/img/app2.jpg') }}" />
                </div>
                <div class="container">
                    <div class="row mb40 mb-xs-24">
                        <div class="col-sm-12 text-center spread-children">
                            <img class="image-xs" alt="Pic" src="{{ URL::asset('assets/img/avatar1.png') }}" />
                            <img class="image-xs" alt="Pic" src="{{ URL::asset('assets/img/avatar2.png') }}" />
                            <img class="image-xs" alt="Pic" src="{{ URL::asset('assets/img/avatar3.png') }}" />
                        </div>
                    </div>
                    <!--end of row-->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <img alt="Logo" class="logo" src="{{ URL::asset('assets/img/logo-light.png') }}" />
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="widget">
        ...
        <script src="{{ URL::asset('assets/js/lickr.js') }}"></script>
