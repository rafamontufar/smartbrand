		...
		-->
				...
				<div class="col-md-6">
					<div class="panel panel-success widget-support-tickets" id="dashboard-support-tickets">
						<div class="panel-heading">
							<span class="panel-title"><i class="panel-title-icon fa fa-bullhorn"></i>Promote Keywords </span>
							<div class="panel-heading-controls">
								<div class="panel-heading-text"><a href="#">15 new words</a></div>
							</div>
						</div> <!-- / .panel-heading -->
						...
						<table class="table">
							...
							<tbody class="valign-middle">
								<tr>
									<td>1</td>
									<td>
										<img src="{{ URL::asset('assets/demo/avatars/2.jpg') }}" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@rjang</a>
									</td>
									<td>9</td>
									<td>youtube.com/nduenw124</td>
									<td></td>
								</tr>
								<tr>
									<td>2</td>
									<td>
										<img src="{{ URL::asset('assets/demo/avatars/3.jpg') }}" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@mbortz</a>
									</td>
									<td>7</td>
									<td>youtube.com/powren</td>
									<td></td>
								</tr>
								<tr>
									<td>3</td>
									<td>
										<img src="{{ URL::asset('assets/demo/avatars/4.jpg') }}" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@towens</a>
									</td>
									<td>6</td>
									<td>youtube.com/fgyew294</td>
									<td></td>
								</tr>
								<tr>
									<td>4</td>
									<td>
										<img src="{{ URL::asset('assets/demo/avatars/5.jpg') }}" alt="" style="width:26px;height:26px;" class="rounded">&nbsp;&nbsp;<a href="#" title="">@dsteiner</a>
									</td>
									<td>6</td>
									<td>youtube.com/dsteiner</td>
									<td></td>
								</tr>
								<tr>
									<td>5</td>
